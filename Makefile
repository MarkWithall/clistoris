...
$(BIN)/linked_list_iterator_tests$(DOTEXE): linked_list_iterator_tests_runner.c $(OBJ)/linked_list_iterator_tests.o
	$(CC) $(CFLAGS) -o $@ $< $(OBJ)/linked_list_iterator_tests.o $(OBJ)/linked_list.o $(OBJ)/list_data.o $(OBJ)/test.o

$(BIN)/linked_list_collection_tests$(DOTEXE): linked_list_collection_tests_runner.c $(OBJ)/linked_list_collection_tests.o
	$(CC) $(CFLAGS) -o $@ $< $(OBJ)/linked_list_collection_tests.o $(OBJ)/linked_list.o $(OBJ)/list_data.o $(OBJ)/test.o

$(BIN)/linked_list_list_tests$(DOTEXE): linked_list_list_tests_runner.c $(OBJ)/linked_list_list_tests.o
	$(CC) $(CFLAGS) -o $@ $< $(OBJ)/linked_list_list_tests.o $(OBJ)/linked_list.o $(OBJ)/list_data.o $(OBJ)/test.o
